...
let aa = "123";
document.querySelector('body').innerHTML = "<h1>161231231233</h1>";
console.log(Object.getOwnPropertyNames(XMLHttpRequest.prototype));
...
(function () {
    ...
    function myAjax() {
        new Promise(function (resolve,reject) {
            ...
            xmlHttp.open("GET", "../../package.json", false);//开启xmlHttp（配置相关选项）
